...
func main() {
	...
	*/
	...
	apiV1XuperGroup := app.Group("/api/v1/xuper", swagin.Tags("XuperChainV1"))
	{
		...
		apiV1XuperGroup.POST("/collection/mint", apiV1XuperCollectionMint)
		apiV1XuperGroup.GET("/collection/:collection", apiV1XuperCollectionInfo)
		...
		// apiV1XuperGroup.GET("/collection/:collection/tokenUri/:id", apiV1XuperContractQuery)
		// total issuance
		// apiV1XuperGroup.GET("/collection/:collection/token/:id", apiV1XuperContractQuery)
		// apiV1XuperGroup.GET("/collection/:collection/balanceOf/:address/:id", apiV1XuperCollectionBalanceOf)
